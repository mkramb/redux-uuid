...
})(this, function(__WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, 'wrapAsGlobalAction', {
	  enumerable: true,
	  get: function get() {
	    return _actions.wrapAsGlobalAction;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createUUIDReducer = function createUUIDReducer(reducers) {
	  var splitReducers = _lodash2.default.mapValues(reducers, function (reducer) {
	    return function () {
	      var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	      var action = arguments[1];

	      if (!_lodash2.default.has(action, ['meta', _constants.UUID_KEY])) return _lodash2.default.mapValues(state, function (innerState) {
	  ...
	  return function () {
	    ...
	    if (!_lodash2.default.has(action, ['meta', _constants.NAME_KEY])) return _lodash2.default.mapValues(splitReducers, function (reducer, key) {
	      return reducer(state[key], action);
	    });

	    var name = action.meta[_constants.NAME_KEY];

	    return Object.assign({}, state, _defineProperty({}, name, splitReducers[name](state[name], action)));
	  };
	};
	  ...
	  return function (Component) {
	    ...
	    var wrapMapDispatchToProps = function wrapMapDispatchToProps(dispatch, _ref2) {
	      ...
	      if (_lodash2.default.isPlainObject(mapDispatchToProps)) {
	        ...
	        return function () {
	          return (0, _redux.bindActionCreators)(mapDispatchToProps, function (action) {
	            return _lodash2.default.isFunction(action) ? action(function (action) {
	              return dispatch((0, _actions.wrapAction)(action, name, uuid));
	            }) : dispatch((0, _actions.wrapAction)(action, name, uuid));
	          });
	        };
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.wrapAsGlobalAction = exports.wrapAction = exports.unregister = exports.register = undefined;
	...
	var wrapAction = exports.wrapAction = function wrapAction(action, name, uuid) {
	  var _extends2;

	  var isGlobal = _lodash2.default.has(action, ['meta', _constants.GLOBAL_KEY]) && action.meta[_constants.GLOBAL_KEY];

	  if (isGlobal) {
	    return _lodash2.default.omit(action, 'meta');
	  }
	...
	var wrapAsGlobalAction = exports.wrapAsGlobalAction = function wrapAsGlobalAction(action) {
	  return _extends({}, action, {
	    meta: _defineProperty({}, _constants.GLOBAL_KEY, true)
	  });
	};
